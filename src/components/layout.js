        ...
        <div className={`inner-header ${headerScrollClass} ${headerBoxShadowClass}`}>
          ...
          >
            ...
            <div className={`mobile-menu ${hamburgerClass}`}>
              <Link to={`/`} className={`no-underline center-text`}><h3 className={`mobile-menu-item`}>Writings</h3></Link>
              <Link to={`/reading-list`} className={`no-underline center-text`}><h3 className={`mobile-menu-item`}>Reading List</h3></Link>
              <Link to={`/about`} className={`no-underline center-text`}><h3 className={`mobile-menu-item`}>About</h3></Link>
            </div>
          </nav>
        </div>
      </header>
